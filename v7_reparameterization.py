...
batch_size = 1
model = "runs/train/v7tiny_ball_detection2/weights/last.pt"
yaml_file = "cfg/training/yolov7-tiny.yaml"
class_num = 1
save_model = "runs/train/v7tiny_ball_detection2/weights/last_re.pt"
